...
public class HotelReservationTest {
    ...
    void givenCheckInAndCheckOutDates_ShouldReturn_CheapestHotel() throws DateFormatException {
        Hotel hotel = hotelReservationService.getCheapestBestRatedHotel("23-05-2022", "27-05-2022", HotelReservationService.CustomerType.REGULAR);
    ...
    void givenWeekendDates_ShouldReturn_CheapestHotel() throws DateFormatException {
        Hotel hotel = hotelReservationService.getCheapestBestRatedHotel("28-05-2022", "29-05-2022", HotelReservationService.CustomerType.REGULAR);
    ...
    void givenDateRange_ShouldReturn_CheapestBestRatedHotel() throws DateFormatException {
        Hotel hotel = hotelReservationService.getCheapestBestRatedHotel("23-05-2022", "31-05-2022", HotelReservationService.CustomerType.REGULAR);
        Assertions.assertEquals("Bridgewood", hotel.getName());
    }
    ...
    void givenWeekendDates_ForRewardedCustomersReturn_CheapestHotel() throws DateFormatException {
        Hotel hotel = hotelReservationService.getCheapestBestRatedHotel("28-05-2022", "29-05-2022", HotelReservationService.CustomerType.REWARDED);
        Assertions.assertEquals("Ridgewood", hotel.getName());
    }
